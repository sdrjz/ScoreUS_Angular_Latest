...
@Component({
  selector: 'app-superadminscorecarddashboard',
  templateUrl: './superadminscorecarddashboard.component.html',
  styleUrls: ['./superadminscorecarddashboard.component.css']
})
export class SuperadminscorecarddashboardComponent implements OnInit,OnDestroy {
  ...
  getAllDashBoardData(){
    ...
    Promise.all([
      this._apiService.get(`${api.superAdminDashboardProduct}?startDate=${this.startDate}&endDate=${this.endDate}&type=1`).toPromise(),
