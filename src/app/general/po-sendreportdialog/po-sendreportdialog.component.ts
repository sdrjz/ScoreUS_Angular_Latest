...
@Component({
  selector: 'app-po-sendreportdialog',
  templateUrl: './po-sendreportdialog.component.html',
  styleUrls: ['./po-sendreportdialog.component.css']
})
export class PoSendreportdialogComponent implements OnInit {
...
// },
 ...
 listEmails: string[] = []
  ...
  constructor(public dialog: MatDialog,
    public dialogRef: MatDialogRef<PoSendreportdialogComponent>
