...
@Component({
  selector: 'app-plantsreporthistory',
  templateUrl: './plantsreporthistory.component.html',
  styleUrls: ['./plantsreporthistory.component.css']
})
export class PlantsreporthistoryComponent implements OnInit {
  loggedInUser:any
  ...
  ngOnInit(): void {
   ...
   this.apiRequestData.reportFor = 0
