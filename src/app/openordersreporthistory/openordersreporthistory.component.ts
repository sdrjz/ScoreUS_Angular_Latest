...
@Component({
    selector: 'app-openordersreporthistory',
    templateUrl: './openordersreporthistory.component.html',
    styleUrls: ['./openordersreporthistory.component.css']
})
export class OpenordersreporthistoryComponent implements OnInit {
    constructor(
